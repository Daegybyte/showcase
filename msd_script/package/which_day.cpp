...
//    make libmsdscript.a
//ar -ruv libmsdscript.a cmdline.o Expr.o parse.o val.o Env.o Cont.o step.o
//c++ -std=c++14 -O2 -I ../msdscript_deploy -o which_day which_day.cpp ../msdscript_deploy/libmsdscript.a
//./which_day 13
